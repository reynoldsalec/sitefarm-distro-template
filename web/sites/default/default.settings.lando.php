...
/**
 * @file
 * Lando local development override configuration.
 *
 * If you run `lando start` on the sitefarm-distro-template, lando will
 * automatically use this config.
 *
...
/**
 * Default Lando database settings - Edit only if you change Lando config.
 */
